...
class Ui_jarvisUi(object):
    def setupUi(self, jarvisUi):
        ...
        jarvisUi.resize(1438, 890)
        self.centralwidget = QtWidgets.QWidget(jarvisUi)
        self.centralwidget.setObjectName("centralwidget")
        self.label = QtWidgets.QLabel(self.centralwidget)
        self.label.setGeometry(QtCore.QRect(0, -10, 1471, 881))
        self.label.setText("")
        self.label.setPixmap(QtGui.QPixmap("../../Pictures/JARVIS/LIVE i.gif"))
        self.label.setObjectName("label")
        self.label_2 = QtWidgets.QLabel(self.centralwidget)
        self.label_2.setGeometry(QtCore.QRect(10, 9, 311, 111))
        self.label_2.setText("")
        self.label_2.setPixmap(QtGui.QPixmap("../../Pictures/JARVIS/Jarvis_Loading_Screen.gif"))
        self.label_2.setObjectName("label_2")
        self.textBrowser = QtWidgets.QTextBrowser(self.centralwidget)
        self.textBrowser.setGeometry(QtCore.QRect(810, 20, 141, 51))
...
"font-size:20px;")
        ...
        self.textBrowser_2.setGeometry(QtCore.QRect(950, 20, 141, 51))
...
"font-size:20px;")
        ...
        self.pushButton.setGeometry(QtCore.QRect(950, 730, 101, 41))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.pushButton_2.setGeometry(QtCore.QRect(1050, 730, 101, 41))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
